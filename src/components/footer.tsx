    ...
    return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="mt-4">
                            <img src="https://www.phonepe.com/webstatic/8420/static/phonepe-pg-default-og-bf9e20a4bc20cca4a0536fbe4792c3ad.png" alt="PhonePe" className="w-1/2 h-1/2 p-2  m-auto rounded hover:scale-125 hover:ease-in-out hover:duration-200"/>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-600 text-center text-sm">
            <p className="text-gray-400">
                ...
                <span className="ml-2">Designed & Maintained By 
                    <Link href="#" className="text-white hover:text-gray-300">92bytes</Link>
                </span>
            </p>
        </div>
    </footer>
