...
export default function Button({ children, className = "" }: ButtonProps) {
    return (
        <button
            className={`group relative overflow-hidden font-bold border-3 border-primary bg-primary text-white rounded-full py-3 px-5 transition-all duration-300 ease-in-out ${className}`}
        >
